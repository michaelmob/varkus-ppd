...
urlpatterns = [
	...
	url(r"^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$", auth_views.password_reset_confirm, {"template_name": "users/password/password_reset_confirm.html"}, name="password_reset_confirm"),
