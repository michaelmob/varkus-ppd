...
def random(length=5):
	"""
	Returns randomly generated string of 'length' length.
	"""
...
WORDS = [
	...
	"grape", "raisin", "grapefruit", "guava", "huckleberry", "jabuticaba",
	"jackfruit", "jambul", "jujube", "kiwifruit", "kumquat", "lemon", "lime",
	"loquat", "longan", "lychee", "mango", "marionberry", "melon", "cantaloupe",
	"honeydew", "watermelon", "mulberry", "nectarine", "nance", "olive",
	"orange", "clementine", "mandarine", "tangerine", "papaya", "peach", "pear",
	"persimmon", "physalis", "plantain", "plum", "prune", "pineapple",
	"pomegranate", "pomelo", "quince", "raspberry", "salmonberry", "rambutan",
	"redcurrant", "salak", "satsuma", "strawberry", "tamarillo", "tamarind",
	"tomato"
]